...
MESSAGE:New("Kola CTLD loaded."):ToAll()
...
ctld.pickupZones = {
    ...
    { "pickzone3", "blue", 0, "yes", 2 },
    { "pickzone4", "none", -1, "yes", 0 },
    { "pickzone5", "none", -1, "yes", 0 },
    { "Naval-4-1", "none", -1, "yes", 2 },
	{ "Invincible-1-1", "none", 0, "yes", 2 },
    { "CVN-75", "none", -1, "200", 2 },
...
ctld.dropOffZones = {
    ...
    { "dropzone4", "none", 2 },
    { "dropzone5", "white", 2 },
	{ "SAMdropzone1", "white", 2 },
	{ "SAMdropzone2", "white", 2 },
    { "SAMdropzone3", "white", 2 },
    { "dropzone7", "white", 2 },
    { "dropzone8", "white", 2 },
    { "dropzone9", "white", 2 },
    { "RedDropzone1", "none", 1 },
	{ "KalixDropzone", "none", 2 },
}
...
ctld.wpZones = {
    ...
    { "wpzone8", "none","yes", 1 },
    { "wpzone9", "none","yes", 1 },
    { "wpzone10", "none","no", 1 }, -- Both sides as its set to 0
}
...
ctld.loadableGroups = {
    {name = ctld.i18n_translate("Standard Group"), inf = 4, mg = 2, at = 2 }, -- will make a loadable group with 6 infantry, 2 MGs and 2 anti-tank for both coalitions
...
function ctld.changeRemainingGroupsForPickupZone(_zoneName, _amount)
   ...
   --[[ for _, _zoneDetails in pairs(ctld.pickupZones) do
	 ...
	 -- Trouve l'index de la zone dans pickupZones
    for i, _zoneDetails in ipairs(ctld.pickupZones) do
        if _zoneName == _zoneDetails[1] then
            -- Passe l'index numérique au lieu du nom
            ctld.updateZoneCounter(i, _amount)
            return -- Arrête la boucle après mise à jour
        end
    end
...
function ctld.orderGroupToMoveToPoint(_leader, _destination)
    ...
    timer.scheduleFunction(function(_arg)
        ...
        if _grp ~= nil then
            local _controller = _grp:getController();
            Controller.setOption(_controller, AI.Option.Ground.id.ALARM_STATE, AI.Option.Ground.val.ALARM_STATE.AUTO) -- Modif Mathieu ALARM_STATE.AUTO à ALARM_STATE.GREEN
